...
| 2 Scan | 🔨 進行中 | T2.1 解析器 ✅ T2.2 OCR ✅ T2.3 ML Kit+CameraX 即時掃描 ✅(碼面/裝置實測待使用者) T2.4 ViewModel ✅ T2.5 UI ✅ / 統編→店名 lookup(Phase 2) 待做 |
| 3 List/Search | ⛔ | |
| 4 Lottery | ⛔ | |
| 5 Export | ⛔ | |
| 6 MCP Server | ⛔ | |
